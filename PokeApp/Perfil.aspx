    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="mb-3">
                ...
                <%--<asp:RangeValidator ErrorMessage="Fuera de rango" ControlToValidate="txtNombre" Type="Integer" MinimumValue="1" MaximumValue="20" runat="server" />--%>
                <asp:RegularExpressionValidator ErrorMessage="Solo numeros" ControlToValidate="txtNombre" ValidationExpression="^[0-9]+$" runat="server" />
            </div>
            <div class="mb-3">
