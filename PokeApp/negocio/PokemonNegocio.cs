    ...
    public class PokemonNegocio
    {
        public List<Pokemon> listar(string id = "")
        {
            ...
            try
            {
                ...
                comando.CommandText = "select P.Numero, P.Nombre, P.Descripcion, UrlImagen, E.Descripcion Tipo, D.Descripcion Debilidad, P.IdTipo, P.IdDebilidad, P.Id, P.Activo from POKEMONS P, ELEMENTOS E, ELEMENTOS D where E.Id = P.IdTipo AND D.Id = P.IdDebilidad ";
                if (id != "")
        ...
        public List<Pokemon> filtrar(string campo, string criterio, string filtro, string estado)
        {
            ...
            try
            {
                ...
                string consulta = "select P.Numero, P.Nombre, P.Descripcion, UrlImagen, E.Descripcion Tipo, D.Descripcion Debilidad, P.IdTipo, P.IdDebilidad, P.Id, P.Activo from POKEMONS P, ELEMENTOS E, ELEMENTOS D where E.Id = P.IdTipo AND D.Id = P.IdDebilidad AND ";
                if (campo == "Numero")
                {
                    switch (criterio)
                    {
